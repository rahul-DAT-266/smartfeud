                                ...
                                if(usr_result){
                                    ...
                                    usr_result.save(function(updt_err,updt_result){
                                        if(updt_err){
                                            ...
                                            //         //console.log(get_usr);
                                            //         var usrData = {};
                                            //         //usrData.auth_token = get_usr.auth_token;
                                            //         usrData.username = get_usr.name;
                                            //         usrData.email = get_usr.email;
                                            //         if(get_usr.image){
                                            //             if(url_regexp.test(get_usr.image)){
                                            //                 usrData.image = get_usr.image;
                                            //             }else{
                                            //                 usrData.image = live_url+'uploads/'+get_usr.image;
                                            //             }
                                            //         }else{
                                            //             usrData.image = live_url+'uploads/no-user.png';
                                            //         }
                                            //         result.status="success";
                                            //         result.message="profile updated successfully!";
                                            //         result.auth_token = get_usr.auth_token;
                                            //         result.data = usrData;
                                            //         res.json(result);
                                            //     }
                                            // });
